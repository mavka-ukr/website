window.__randomize_color__ = function () {
  ...
  document.documentElement.style.setProperty(
    "--primary-hover-rgb",
    `var(--${colorName}-hover-rgb`,
  );
  document.documentElement.style.setProperty(
    "--primary-pressed-rgb",
    `var(--${colorName}-pressed-rgb`,
  );
  document.documentElement.style.setProperty(
    "--primary-text-rgb",
    `var(--${colorName}-text-rgb`,
  );
  document.documentElement.style.setProperty(
    "--primary-transparent-button-rgb",
    `var(--${colorName}-transparent-button-rgb`,
  );
};
...
document.querySelector(".XDocsPageNavigationFooter").innerHTML +=
  `<button class="XDocsPageNavigationFooterConfigButton">
...
if (document.title.includes("Документація Мавки")) {
  document.querySelector(".XDocsPageNavigationFooter").innerHTML =
    `<button class="XDocsPageNavigationFooterTeoButton">
<svg viewBox="0 0 501 501" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  document
    .querySelector(".XDocsPageNavigationFooterTeoButton")
...
document
  .querySelector(".XDocsPageNavigationFooterConfigButton")
  .addEventListener("click", () => {
    const currentMode = localStorage.getItem("mavka_ukr_light_mode");
    if (currentMode === "auto") {
